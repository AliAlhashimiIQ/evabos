...
contextBridge.exposeInMainWorld('evaApi', {
  ...
  reports: {
    ...
    leastProfitableItems: (token: string, params: { startDate: string; endDate: string; exchangeRate?: number; limit?: number; season?: string | null }) => ipcRenderer.invoke('reports:leastProfitableItems', token, params),
    leastProfitableSuppliers: (token: string, params: { startDate: string; endDate: string; exchangeRate?: number; season?: string | null }) => ipcRenderer.invoke('reports:leastProfitableSuppliers', token, params),
